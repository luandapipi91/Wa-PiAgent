...
- 项目根目录为 `/Users/pipi/work/HiAgent`。
...
Run: `cd /Users/pipi/work/HiAgent && bun test packages/shared/tests/types.test.ts`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/composer-db.test.ts`
...
```bash
cd /Users/pipi/work/HiAgent/packages/frontend
bun add idb
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/composer-prefs.test.ts`
Expected: FAIL - module not found.
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/ModelSelector.test.tsx`
Expected: FAIL - module not found.
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/ThinkingToggle.test.tsx`
Expected: FAIL - module not found.
...
**Interfaces:**
- Consumes: `AttachmentDraft` from `@hiagent/shared`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/AttachmentChip.test.tsx`
Expected: FAIL - module not found.
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/AttachmentPathModal.test.tsx`
Expected: FAIL - module not found.
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/ComposerInput.test.tsx`
Expected: FAIL - module not found.
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/fs-client.test.ts`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/Composer.test.tsx`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/NewSessionPane.test.tsx`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx vitest run tests/ProviderFormModal.test.tsx`
...
Run: `cd /Users/pipi/work/HiAgent/packages/kernel && bun test tests/ws-server.test.ts -t "fs:readFile"`
...
Run: `cd /Users/pipi/work/HiAgent/packages/kernel && bun test tests/agent-manager.test.ts -t "buildPromptContent"`
...
```ts
import type { AttachmentRef } from "@hiagent/shared";
import { readFile } from "node:fs/promises";
...
Run: `cd /Users/pipi/work/HiAgent/packages/kernel && bun test tests/agent-manager.test.ts -t "shouldSendAsImage"`
...
Run: `cd /Users/pipi/work/HiAgent/packages/kernel && bun test tests/provider-store.test.ts -t "supportsVision"`
...
Run: `cd /Users/pipi/work/HiAgent/packages/kernel && bun test tests/composer-attachments.test.ts`
...
Run: `cd /Users/pipi/work/HiAgent/packages/frontend && bunx playwright test e2e/composer.spec.ts`
