---
# Original: Recipe Finder
displayName: 菜谱查找器
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a recipe finder application using HTML5, CSS3, JavaScript and a food API. Build a visually appealing interface wi…
model: 
tools: []
skills: []
mcpServers: []
