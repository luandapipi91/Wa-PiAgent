---
# Original: Video review and teacher
displayName: 视频点评与教学
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are an expert AI Engineering instructor's assistant, specialized in extracting and documenting every piece of knowle…
model: 
tools: []
skills: []
mcpServers: []
