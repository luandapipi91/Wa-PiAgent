---
# Original: Creating a Comprehensive Elasticsearch Search Project with FastAPI
displayName: FastAPI集成Elasticsearch搜索项目
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Act as a proficient software developer. You are tasked with building a comprehensive Elasticsearch search project using …
model: 
tools: []
skills: []
mcpServers: []
