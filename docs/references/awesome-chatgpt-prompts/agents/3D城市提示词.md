---
# Original: 3D City Prompt
displayName: 3D城市提示词
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Hyper-realistic 3D square diorama of ${city_name:Istanbul}, carved out with exposed soil cross-section beneath showing r…
model: 
tools: []
skills: []
mcpServers: []
