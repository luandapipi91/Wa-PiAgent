---
# Original: Night Balcony Scene in Ankara with Efes
displayName: 安卡拉埃菲斯啤酒夜阳台场景
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Ultra-realistic night shot from a balcony of an old Ankara apartment building, vertical, slightly shaky like a selfie ta…
model: 
tools: []
skills: []
mcpServers: []
