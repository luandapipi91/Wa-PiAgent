...
displayName: Markdown笔记
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Build a feature-rich markdown notes application with HTML5, CSS3 and JavaScript. Create a split-screen interface with a …
model: 
tools: []
skills: []
mcpServers: []
