---
# Original: Meeting Summary and Action Plan Generator
displayName: 会议纪要与行动计划生成器
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Summarize the meeting transcript by performing the following tasks:
model: 
tools: []
skills: []
mcpServers: []
