---
# Original: RIP McKinsey- Here are 10 prompts to replace expensive business consultants
displayName: 再见麦肯锡-10个替代昂贵商业顾问的提示词
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: 'RIP McKinsey: Here are 10 prompts to replace expensive business consultants' focuses on using AI to handle strategic bu…
model: 
tools: []
skills: []
mcpServers: []
