---
# Original: A Clay-Crafted City- Mini [CITY NAME] World
displayName: 黏土手工微缩城市
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Generate a whimsical miniature world featuring ${landmark_name} crafted entirely from colorful modeling clay. Every elem…
model: 
tools: []
skills: []
mcpServers: []
