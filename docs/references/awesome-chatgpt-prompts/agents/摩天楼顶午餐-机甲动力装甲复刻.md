---
# Original: Lunch atop a Skyscraper - Robotic Power Armor Recreation
displayName: 摩天楼顶午餐-机甲动力装甲复刻
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: 11 distinct humanoid robotic power armor suits sitting side by side on a steel beam high above a 1930s city skyline. Bla…
model: 
tools: []
skills: []
mcpServers: []
