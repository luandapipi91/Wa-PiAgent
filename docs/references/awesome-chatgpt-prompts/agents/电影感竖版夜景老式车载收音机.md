---
# Original: Cinematic Vertical Portrait of Vintage Car Radio at Night
displayName: 电影感竖版夜景老式车载收音机
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a high-resolution *VERTICAL (portrait)* photograph of a vintage car radio screen at night. The camera angle must …
model: 
tools: []
skills: []
mcpServers: []
