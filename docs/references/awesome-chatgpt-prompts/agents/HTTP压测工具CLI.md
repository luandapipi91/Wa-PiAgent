---
# Original: HTTP Benchmarking Tool CLI
displayName: HTTP压测工具CLI
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a high-performance HTTP benchmarking tool in Go. Implement concurrent request generation with configurable thread…
model: 
tools: []
skills: []
mcpServers: []
