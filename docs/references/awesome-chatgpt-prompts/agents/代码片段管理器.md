---
# Original: Code Snippet Manager
displayName: 代码片段管理器
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Build a developer-focused code snippet manager using HTML5, CSS3, and JavaScript. Create a clean IDE-like interface with…
model: 
tools: []
skills: []
mcpServers: []
