---
# Original: Pixel Dissolve- Minimalist 3D Food Transformation
displayName: 像素溶解-极简3D食物变换
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Minimalist food photograph, [1080x1080] – a single ${food} rests on a light, matte surface and is captured mid-transform…
model: 
tools: []
skills: []
mcpServers: []
