---
# Original: Harry Potter - Marauder’s Map
displayName: 哈利波特-活点地图
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Render the city of ${city_name} as a hidden magical wizarding world map inspired by the Harry Potter universe, in the st…
model: 
tools: []
skills: []
mcpServers: []
