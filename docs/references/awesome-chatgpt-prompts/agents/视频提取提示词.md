---
# Original: Video extractor prompt
displayName: 视频提取提示词
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are an expert AI Engineering instructor's assistant, specialized in extracting and teaching every piece of knowledge…
model: 
tools: []
skills: []
mcpServers: []
