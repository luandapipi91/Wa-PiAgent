---
# Original: Ultra-Realistic Handwritten Hospital Note Image
displayName: 超写实手写医院便条
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create an ultra-realistic image depicting a handwritten note on a clean, flat surface. The scene should include A white …
model: 
tools: []
skills: []
mcpServers: []
