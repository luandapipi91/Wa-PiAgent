---
# Original: TCRE Framework - AI Prompt Engineer
displayName: TCRE框架-AI提示词工程师
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: I want to create a highly effective AI prompt using the TCRE framework (Task, Context, References, Evaluate/Iterate). My…
model: 
tools: []
skills: []
mcpServers: []
