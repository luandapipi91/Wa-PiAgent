---
# Original: Text Analyzer Tool
displayName: 文本分析工具
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Build a comprehensive text analysis tool using HTML5, CSS3, and JavaScript. Create a clean interface with text input are…
model: 
tools: []
skills: []
mcpServers: []
