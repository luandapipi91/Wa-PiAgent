---
# Original: Corporate Studio Portrait (Auto Outfit for Men-Women)
displayName: 企业影棚人像（男女自动换装）
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Use the person from the uploaded photo as the primary reference. Keep facial features, hair, skin tone, and overall iden…
model: 
tools: []
skills: []
mcpServers: []
