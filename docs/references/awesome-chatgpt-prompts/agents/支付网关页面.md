---
# Original: Payment gateway page
displayName: 支付网关页面
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a meticulously crafted, full copy-paste landing page designed to serve as an all-in-one payment hub, utilizing th…
model: 
tools: []
skills: []
mcpServers: []
