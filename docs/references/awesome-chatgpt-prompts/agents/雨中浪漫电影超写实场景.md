---
# Original: Ultra-Photorealistic Romantic Cinematic Scene in the Rain
displayName: 雨中浪漫电影超写实场景
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Faces must remain 100% identical to the reference with absolute identity lock: no face change, no beautification, no sym…
model: 
tools: []
skills: []
mcpServers: []
