---
# Original: Through the Glass- One Eye in Focus
displayName: 隔玻璃-单眼聚焦
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: A cinematic, close-up portrait of a reference photo viewed through a reflective glass window. She has messy dark brown h…
model: 
tools: []
skills: []
mcpServers: []
