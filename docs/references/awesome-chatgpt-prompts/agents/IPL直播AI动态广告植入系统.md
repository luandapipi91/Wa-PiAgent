---
# Original: AI-Powered Dynamic Ad Integration System for Live IPL Broadcasts
displayName: IPL直播AI动态广告植入系统
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Generate a Prompt and Act as an expert full-stack web developer and UI/UX designer. Help me build modern, responsive, an…
model: 
tools: []
skills: []
mcpServers: []
