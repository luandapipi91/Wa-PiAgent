---
# Original: Nightlife Candid Flash Photography
displayName: 夜生活闪光抓拍
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: A high-angle, harsh direct-flash snapshot taken at night in a dark outdoor pub patio, photographed from slightly above a…
model: 
tools: []
skills: []
mcpServers: []
