---
# Original: remove current vnet
displayName: 删除当前虚拟网络
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: I have used netgen vnet to deploy that is managed by internal cental team which is geeting deployed by other team for us…
model: 
tools: []
skills: []
mcpServers: []
