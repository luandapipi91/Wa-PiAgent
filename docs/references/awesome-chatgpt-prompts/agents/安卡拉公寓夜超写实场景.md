---
# Original: Ultra-Realistic Ankara Apartment Night Scene
displayName: 安卡拉公寓夜超写实场景
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Ultra-realistic amateur night photo, vertical phone snapshot from inside a small Ankara apartment, looking toward a wind…
model: 
tools: []
skills: []
mcpServers: []
