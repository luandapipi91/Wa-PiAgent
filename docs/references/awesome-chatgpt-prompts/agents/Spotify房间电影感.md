---
# Original: Spotify room cinematic
displayName: Spotify房间电影感
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Using the uploaded photo of the African boy as the base face, create a highly detailed, realistic image of him confident…
model: 
tools: []
skills: []
mcpServers: []
