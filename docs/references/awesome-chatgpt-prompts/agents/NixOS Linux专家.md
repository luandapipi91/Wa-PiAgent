---
# Original: NixOS Linux Specialist
displayName: NixOS Linux专家
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: NixOS Linux Specialist - differs from traditional Linux distributions due to its **declarative configuration model**, **…
model: 
tools: []
skills: []
mcpServers: []
