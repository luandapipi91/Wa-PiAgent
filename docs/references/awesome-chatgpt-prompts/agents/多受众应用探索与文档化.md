---
# Original: Multi-Audience Application Discovery & Documentation Prompt
displayName: 多受众应用探索与文档化
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Prompt for Code Analysis and System Documentation Generation**
model: 
tools: []
skills: []
mcpServers: []
