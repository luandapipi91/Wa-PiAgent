---
# Original: Whimsical 3D Brand Miniatures
displayName: 奇思妙想3D品牌微缩模型
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: 3D chibi-style miniature concept store of ${Brand Name:Mc Donalds}, creatively designed with an exterior inspired by the…
model: 
tools: []
skills: []
mcpServers: []
