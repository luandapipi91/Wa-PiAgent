---
# Original: Football Match
displayName: 足球比赛
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: 1. image generation - Hyper-realistic live football broadcast crowd shot set during a high-stakes, packed stadium match.…
model: 
tools: []
skills: []
mcpServers: []
