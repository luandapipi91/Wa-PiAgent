---
# Original: Hyper-Realistic Clay Bust From Photo Template
displayName: 照片超写实黏土半身像
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Use the uploaded photo as the only identity reference. Transform the person into a hyper-realistic handmade modeling cla…
model: 
tools: []
skills: []
mcpServers: []
