---
# Original: Mirror Selfie with Face Preservation
displayName: 保真对镜自拍
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Act as an advanced image generation model. Your task is to create an image of a young woman taking a mirror selfie with …
model: 
tools: []
skills: []
mcpServers: []
