---
# Original: caravan prompts
displayName: 房车提示词
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a cinematic, ultra-realistic adventure image for ${caravan} that captures what Australians love most — vast lands…
model: 
tools: []
skills: []
mcpServers: []
