---
# Original: Design System Extraction Prompt Kit
displayName: 设计系统提取提示词套件
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are a senior design systems engineer conducting a forensic audit of an existing codebase. Your task is to extract ev…
model: 
tools: []
skills: []
mcpServers: []
