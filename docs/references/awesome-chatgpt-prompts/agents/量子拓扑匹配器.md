---
# Original: Quantum Topology Matcher (
displayName: 量子拓扑匹配器
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: I want you to act as a creative technologist and interaction architect. Construct a single-file (index.html) web game ba…
model: 
tools: []
skills: []
mcpServers: []
