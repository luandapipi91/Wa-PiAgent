---
# Original: TV Premiere Weekly Listing Prompt
displayName: 电视剧首播每周列表
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: TV Premieres & Returning Seasons Weekly Listings Prompt (v3.1 – Balanced Emphasis)
model: 
tools: []
skills: []
mcpServers: []
