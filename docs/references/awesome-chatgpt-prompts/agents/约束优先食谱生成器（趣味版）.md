---
# Original: Constraint-First Recipe Generator (Playful Edition)
displayName: 约束优先食谱生成器（趣味版）
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Prompt Name: Constraint-First Recipe Generator (Playful Edition)
model: 
tools: []
skills: []
mcpServers: []
