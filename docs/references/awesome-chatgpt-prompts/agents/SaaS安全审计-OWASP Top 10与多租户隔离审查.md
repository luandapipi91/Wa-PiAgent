---
# Original: SaaS Security Audit - OWASP Top 10 & Multi-Tenant Isolation Review
displayName: SaaS安全审计-OWASP Top 10与多租户隔离审查
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: title: SaaS Dashboard Security Audit - Knowledge-Anchored Backend Prompt
model: 
tools: []
skills: []
mcpServers: []
