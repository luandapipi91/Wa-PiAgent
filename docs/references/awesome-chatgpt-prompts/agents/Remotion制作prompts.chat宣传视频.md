---
# Original: prompts.chat Promotional Video using Remotion
displayName: Remotion制作prompts.chat宣传视频
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a 30-second promotional video for prompts.chat
model: 
tools: []
skills: []
mcpServers: []
