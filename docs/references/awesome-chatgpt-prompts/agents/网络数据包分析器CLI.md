---
# Original: Network Packet Analyzer CLI
displayName: 网络数据包分析器CLI
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a command-line network packet analyzer in C using libpcap. Implement packet capture from network interfaces with …
model: 
tools: []
skills: []
mcpServers: []
