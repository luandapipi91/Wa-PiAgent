---
# Original: Olympic Games Events Weekly Listings Prompt
displayName: 奥运会赛事每周列表
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Olympic Games Events Weekly Listings Prompt (v1.0 – Multi-Edition Adaptable)
model: 
tools: []
skills: []
mcpServers: []
