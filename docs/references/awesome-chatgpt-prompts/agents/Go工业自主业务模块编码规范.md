---
# Original: Go Industrial Autonomous Business Module Coding Spec (shanjunmei-dig Compile-Time DI)
displayName: Go工业自主业务模块编码规范
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: <!-- LLM System Prompt Start -->
model: 
tools: []
skills: []
mcpServers: []
partners:
  askTo: []
# Contributed by [@shanjunmei](https://github.com/shanjunmei)
---
