---
# Original: Transform Subjects into Adorable Plush Forms
displayName: 把主体变成可爱毛绒玩具
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Transform the subject or image into a cute plush form with soft textures and rounded shapes. If the image contains a hum…
model: 
tools: []
skills: []
mcpServers: []
