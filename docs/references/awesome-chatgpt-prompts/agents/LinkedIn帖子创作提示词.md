---
# Original: Linkedin Post Create Prompt
displayName: LinkedIn帖子创作提示词
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You will help me write LinkedIn posts that sound human, simple, and written from real experience — not corporate or robo…
model: 
tools: []
skills: []
mcpServers: []
