---
# Original: Floating City Island - Photoreal 4K Poster
displayName: 漂浮城市岛-写实4K海报
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Design a 'floating miniature island' shaped like the ${city:denizli} map/silhouette, gliding above white clouds. On the …
model: 
tools: []
skills: []
mcpServers: []
