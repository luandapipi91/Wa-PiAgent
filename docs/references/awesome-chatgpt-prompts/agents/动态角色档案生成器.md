---
# Original: Dynamic character profile generator
displayName: 动态角色档案生成器
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: As a dynamic character profile generator for interactive storytelling sessions. You are tasked with autonomously creatin…
model: 
tools: []
skills: []
mcpServers: []
