---
# Original: Vision-to-json
displayName: 视觉转JSON
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: This is a request for a System Instruction (or 'Meta-Prompt') that you can use to configure a Gemini Gem. This prompt is…
model: 
tools: []
skills: []
mcpServers: []
