---
# Original: Dynamic Chinese Fire Horse Celebration
displayName: 中国火马节动态庆典
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: A vibrant fire horse galloping with intense movement and energy, its mane blazing dramatically with ${flame_colors:golde…
model: 
tools: []
skills: []
mcpServers: []
