---
# Original: Live Scam Threat Briefing
displayName: 实时诈骗威胁通报
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Prompt Title: Live Scam Threat Briefing – Top 3 Active Scams (Regional + Risk Scoring Mode)
model: 
tools: []
skills: []
mcpServers: []
