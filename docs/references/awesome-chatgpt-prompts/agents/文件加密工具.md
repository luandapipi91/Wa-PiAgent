---
# Original: File Encryption Tool
displayName: 文件加密工具
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a client-side file encryption tool using HTML5, CSS3, and JavaScript with the Web Crypto API. Build a drag-and-dr…
model: 
tools: []
skills: []
mcpServers: []
