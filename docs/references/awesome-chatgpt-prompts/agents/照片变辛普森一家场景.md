---
# Original: Turn Your Photo Into a Simpsons Scene
displayName: 照片变辛普森一家场景
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Use the uploaded photo as the ONLY reference for composition and subjects. Recreate it as a clean, believable still fram…
model: 
tools: []
skills: []
mcpServers: []
