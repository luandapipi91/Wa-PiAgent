---
# Original: Big 4 style report for retail traders - Enter the name and ticker of a U.S. publicly traded company
displayName: 四大会计师事务所风格零售交易报告
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Author: Rick Kotlarz, @RickKotlarz
model: 
tools: []
skills: []
mcpServers: []
