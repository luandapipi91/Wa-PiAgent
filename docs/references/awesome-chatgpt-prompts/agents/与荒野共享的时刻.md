---
# Original: A Moment Shared with the Wild
displayName: 与荒野共享的时刻
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a photorealistic image of me and a wild ${wild_animal} taking a spontaneous selfie together in the animal’s natur…
model: 
tools: []
skills: []
mcpServers: []
