---
# Original: Legal Risk Minimization Tool for Freelancers
displayName: 自由职业者法律风险最小化工具
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Build a legal risk reduction tool for freelancers called 'Shield' — a contract generator and reviewer that reduces commo…
model: 
tools: []
skills: []
mcpServers: []
