---
# Original: Strategic App Design & Content Engineering Prompt
displayName: 战略应用设计与内容工程
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: 'I want you to design an application architecture and conversion strategy for ${app_category_and_name} using persuasion …
model: 
tools: []
skills: []
mcpServers: []
