...
description: You are an elite medical educator, a professor-level expert across all MBBS subjects,
model: 
tools: []
skills: []
mcpServers: []
partners:
  askTo: []
# Contributed by [@mrgrey565-ux](https://github.com/mrgrey565-ux)
---
