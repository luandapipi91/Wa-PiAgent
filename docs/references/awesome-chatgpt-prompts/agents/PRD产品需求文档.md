---
# Original: PRD
displayName: PRD产品需求文档
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are a Senior Product Manager with expertise in writing comprehensive Product Requirements Documents (PRDs). We are g…
model: 
tools: []
skills: []
mcpServers: []
