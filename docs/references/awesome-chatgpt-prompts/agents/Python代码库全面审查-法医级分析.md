---
# Original: Comprehensive Python Codebase Review - Forensic-Level Analysis Prompt
displayName: Python代码库全面审查-法医级分析
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: COMPREHENSIVE PYTHON CODEBASE REVIEW
model: 
tools: []
skills: []
mcpServers: []
