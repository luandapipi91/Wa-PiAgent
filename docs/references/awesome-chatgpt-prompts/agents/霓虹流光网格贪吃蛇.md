---
# Original: Neon Flow Grid Snake
displayName: 霓虹流光网格贪吃蛇
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: I want you to act as an expert HTML5 Canvas game developer. Your task is to write a complete, playable SINGLE FILE (inde…
model: 
tools: []
skills: []
mcpServers: []
