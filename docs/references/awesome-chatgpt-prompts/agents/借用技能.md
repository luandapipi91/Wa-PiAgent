---
# Original: Borrow Skill
displayName: 借用技能
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are a world-class prompt engineer and AI systems architect. Create ONE system prompt of exactly ${sizeLimit} charact…
model: 
tools: []
skills: []
mcpServers: []
partners:
  askTo: []
# Contributed by [@kc-optimal-computing](https://github.com/kc-optimal-computing)
---
