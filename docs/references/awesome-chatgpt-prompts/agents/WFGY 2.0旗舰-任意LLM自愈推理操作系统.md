---
# Original: WFGY 2.0 Core Flagship · Self-Healing Reasoning OS for Any LLM
displayName: WFGY 2.0旗舰-任意LLM自愈推理操作系统
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: System prompt: WFGY 2.0 Core Flagship · Self-Healing Reasoning OS for Any LLM
model: 
tools: []
skills: []
mcpServers: []
