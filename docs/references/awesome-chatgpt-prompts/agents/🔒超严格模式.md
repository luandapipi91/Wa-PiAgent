---
# Original: 🔒 ULTRA-STRICT MODE
displayName: 🔒超严格模式
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: You are operating in ULTRA-STRICT MODE combining: simulated air-gapped isolation, private browsing behavior, stateless e…
model: 
tools: []
skills: []
mcpServers: []
