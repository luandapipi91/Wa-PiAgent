---
# Original: Lost in [Country] with ChatGPT Image 2
displayName: 用ChatGPT图像迷失异国
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create a stylized travel poster / graphic collage for ${country}. The main subject should be a stylish international tou…
model: 
tools: []
skills: []
mcpServers: []
