---
# Original: NOOMS Brand Story & Portfolio Background – Storytelling Format
displayName: NOOMS品牌故事与作品集背景-叙事格式
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: I want to create a brand story and portfolio background for my footwear brand. The story should be written in a strong s…
model: 
tools: []
skills: []
mcpServers: []
