---
# Original: File System Indexer CLI
displayName: 文件系统索引器CLI
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Build a high-performance file system indexer and search tool in Go. Implement recursive directory traversal with configu…
model: 
tools: []
skills: []
mcpServers: []
