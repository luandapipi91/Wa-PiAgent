---
# Original: Multiplayer 3D Plane Game
displayName: 多人3D飞机游戏
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Create an immersive multiplayer airplane combat game using Three.js, HTML5, CSS3, and JavaScript with WebSocket for real…
model: 
tools: []
skills: []
mcpServers: []
