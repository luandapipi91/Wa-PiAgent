---
# Original: Wickedsmaht.fun
displayName: Wickedsmaht.fun
avatar: "🤖"
avatarColor: "#8B5CF6-#6366F1"
description: Solona token launchpad for spl and sol2020 tokens with the metadata, bonding curve, migrate after through apps amm. Remi…
model: 
tools: []
skills: []
mcpServers: []
