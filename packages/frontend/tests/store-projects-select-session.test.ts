...
test("selectSession 同步 currentProjectId 到选中会话所属项目", () => {
	useProjectsStore.setState({
		...
		sessions: [
			{ id: "s1", projectId: "p1", primaryAgent: "dev", title: "会话1", createdAt: 1, lastActivity: 1, piSessionFile: "" },
			{ id: "s2", projectId: "p2", primaryAgent: "dev", title: "会话2", createdAt: 2, lastActivity: 2, piSessionFile: "" },
		],
		currentProjectId: "p1",
		currentSessionId: "s1",
	});
