...
// 用独立端口跑 E2E——web 5181 + WS 19876（WA_PI_E2E_WS_PORT 控制），
// 完全复用 playwright.config.ts 的 global-setup/teardown 与隔离 WA_PI_DIR。
// 用法：WA_PI_E2E_WS_PORT=19876 bunx playwright test -c playwright.local.config.ts e2e/chat-blocks.spec.ts
import base from "./playwright.config";

const WEB_PORT = Number(process.env.WA_PI_E2E_WEB_PORT) || 5181;
