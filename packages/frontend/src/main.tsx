...
import { isPreviewWindow } from "./preview-window";
...
// 独立预览窗口（浮动模式的承载窗口）只渲染预览面板：不挂侧栏/聊天/会话逻辑。
// 判定依据是主进程 createPreviewWindow 拼在 loadURL 上的 URL 标记。
if (isPreviewWindow(window.location.search)) {
  root.render(
    <ErrorBoundary>
      <PreviewWindowRoot />
    </ErrorBoundary>,
